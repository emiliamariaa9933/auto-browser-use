...
async def wikipedia_flow():
    ...
    task = """
    Objetivo: Navegar autonomamente na Wikipedia, buscar um termo, abrir um artigo, extrair texto e validar conteúdo.
    ...
    - NUNCA digite nomes de arquivos, comandos ou textos de observação na interface da página.
